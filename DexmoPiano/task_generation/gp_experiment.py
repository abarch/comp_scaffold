...
class GaussianProcess:
    ...
    def _get_plot_data(self, data_dict, c, practice_mode, bayes_opt, for_plot=False):
        ...
        X2_axis = np.linspace(BPM_BOUNDS[0], BPM_BOUNDS[1], 150)
        ...
        data_dict[practice_mode].X2 = X2_axis
    ...
    def _plot_single_practice_mode(self, gp_plot_data, subplotf,
        ...
        bounds = [[gp_plot_data.X1[0], gp_plot_data.X1[-1]], 
                  [gp_plot_data.X2[0], gp_plot_data.X2[-1]]]
    ...
    def plot_mutiple(self, c, practice_modes,
        ...
        fig.tight_layout()
        plt.savefig("detailed_optimal.png")
        plt.show()
