...
class GaussianProcess:
    def __init__(self, bpm_norm_fac=10):
        ...
        self.domain = [
            ...
            {'name': 'note_range_left', 'type': 'categorical', 'domain': (0, 1, 2)},
    ...
    def _params_to_domain(self, complexity_level, task_parameters, practice_mode):
        domain_x = [complexity_level,
                    practicemode2int[practice_mode],
                    noterange2int[task_parameters.note_range_right],
                    noterange2int[task_parameters.note_range_left],
    ...
    def _assign_plot_data_to_data_dict(self, data_dict, c, practice_mode, bayes_opt):
    ...
    def get_policy(self, c):
        ...
        for i, practice_mode in enumerate([PracticeMode.IMP_TIMING,
            ...
            self._assign_plot_data_to_data_dict(data_dict, c, practice_mode, bayes_opt)
            # print("got data")
...
def gen_tasks(num_tasks=1000, seed=546354):
    ...
    for i in range(num_tasks):
        ...
        yield TaskParameters(bpm=bpm, note_range_right=note_range, note_range_left=note_range)
